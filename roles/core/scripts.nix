...
in {
  devTool = pkgs.writeScriptBin "dev" ''
    ...
    *)
      ...
      echo "Commands:"
      echo "new-repo"
      echo "gen - Generates a template in current directory"
    ;;
    esac
  '';

  prjTool = pkgs.writeScriptBin "prj" ''
    case $1 in
    "yinote")
      sed '/<!-- Generated by/d' $2 | sed 's|<!-- ||g' | sed 's| -->||g' | sed 's|##|-|g'
    ;;
    *)
    echo "Usage:"
    echo ""
